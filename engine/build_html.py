...
/* All Players match history — trying a much lighter grey than the results
   tab's 0.85 opacity, per request, before deciding vs. a red-bg treatment. */
.hist-row-dq { font-style: italic; }
.hist-row-dq td { color: #ccc; }
.hist-row-dq .hr { color: #ddd; }
.hist-row-dq .dq-badge { color: #b02a2a; }
